...
public class EaglercraftVersion {
	...
	public static final String projectForkName = "kone Client";
	public static final String projectForkVersion = "22w54a";
	public static final String projectForkVendor = "kone";
	
	public static final String projectForkURL = "https://github.com/konekowo/kone-client-full";
	...
	public static final String mainMenuStringA = "Minecraft Java 1.8.8";
