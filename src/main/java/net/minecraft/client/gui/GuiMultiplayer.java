...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback {
	...
	private void connectToServer(ServerData server) {
		...
		boolean isUsingXrayOnXrayProtextedServer = xraydetector.XrayDetectIps(server);
		if (isUsingXrayOnXrayProtextedServer) {
			this.mc.displayGuiScreen(new GuiXrayDetected(this));
		}
		else {
			System.out.println("User Not Using Xray Pack");
