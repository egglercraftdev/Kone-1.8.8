...
public class GuiChat extends GuiScreen {
	...
	protected void keyTyped(char parChar1, int parInt1) {
		if (parInt1 == 1 && (this.mc.gameSettings.keyBindClose.getKeyCode() == 0 || this.mc.areKeysLocked())) {
			...
			if (parInt1 == 15 && passwordbool == false) {
			...
			if (parInt1 != 28 && parInt1 != 156) {
				if (parInt1 == 200) {
					...
					if (this.inputField.getText().trim().startsWith("/l ") && parInt1 != 15) {
						System.out.println("User is logging in");
						this.inputField.textboxKeyTyped(' ', 14);
						this.inputField.textboxKeyTyped('*', 9);
						this.password = this.password + parChar1;
					...
					else if (this.inputField.getText().trim().startsWith("/log ") && parInt1 != 15) {
						System.out.println("User is logging in");
						this.inputField.textboxKeyTyped(' ', 14);
						this.inputField.textboxKeyTyped('*', 9);
						this.password = this.password + parChar1;
					...
					else if (this.inputField.getText().trim().startsWith("/login ") && parInt1 != 15) {
						System.out.println("User is logging in");
						this.inputField.textboxKeyTyped(' ', 14);
						this.inputField.textboxKeyTyped('*', 9);
						this.password = this.password + parChar1;
					...
					if (parInt1 == 42 && this.password.length() > 0) {
						//this.inputField.textboxKeyTyped(' ', 14);
						this.password = this.password.substring(0, this.password.length()-1);
					}
					if (parInt1 == 14 && this.password.length() > 0) {
						this.password = this.password.substring(0, this.password.length()-2);
					}
					//System.out.println(parInt1);
					//System.out.println(parChar1);
				}
			} else {
	...
	public void drawScreen(int i, int j, float f) {
		...
		if (passwordbool) {
			drawString(this.fontRendererObj, "Hiding Password", 3, this.height - 25, 16770425);
		}
