...
import net.kone.GuiKoneClientMenu;
...
public class GuiIngameMenu extends GuiScreen {
	...
	public void initGui() {
		...
		this.buttonList.add(new GuiButton(9, this.width / 2 - 100, this.height / 4 + 72 + b0, "Open kone Client Menu"));
	...
	protected void actionPerformed(GuiButton parGuiButton) {
		...
		case 7:
			break;
		case 9:
			this.mc.displayGuiScreen(new GuiKoneClientMenu(this, this.mc));
		}
