...
public class GuiButton extends Gui {
	protected static ResourceLocation buttonTextures = new ResourceLocation("textures/gui/widgets.png");
	protected int width;
	...
	public GuiButton(int buttonId, int x, int y, String buttonText, boolean koneButton) {
		this(buttonId, x, y, 200, 20, buttonText);
		if (koneButton) {
			buttonTextures = new ResourceLocation("textures/gui/konesWidgets.png");
		}
	}
