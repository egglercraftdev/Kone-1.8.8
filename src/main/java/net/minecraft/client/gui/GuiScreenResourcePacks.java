...
import net.kone.GuiXrayDetected;
import net.kone.XrayDetector;
...
public class GuiScreenResourcePacks extends GuiScreen {
	...
	private boolean xraydetected = false;
			...
			if (parGuiButton.id == 2) {
				...
				if (this.changed) {
					...
					if (this.mc.getCurrentServerData() != null) {
						System.out.println(this.mc.getCurrentServerData().serverIP);
						XrayDetector xraydetect = new XrayDetector();
						xraydetected = xraydetect.XrayDetectIps(this.mc.getCurrentServerData());
						if (xraydetected) {
				...
				if (xraydetected) {
					this.mc.displayGuiScreen(new GuiXrayDetected(new GuiMultiplayer(new GuiMainMenu())));
				}
				else {
