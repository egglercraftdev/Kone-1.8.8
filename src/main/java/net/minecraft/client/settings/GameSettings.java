...
public class GameSettings {
	...
	public boolean fboEnable = false;
	...
	public boolean keyStrokesMod = true;
	public int fxaa = 2;
	...
	public void setOptionValue(GameSettings.Options parOptions, int parInt1) {
		...
		if (parOptions == GameSettings.Options.KEY_STROKES_MOD) {
			...
			while ((s = bufferedreader.readLine()) != null) {
				try {
					...
					if (astring[0].equals("keyStrokesMod")) {
						this.keyStrokesMod = astring[1].equals("true");
					}
					if (astring[0].equals("fullBright")) {
						this.fullBright = astring[1].equals("true");
					}
	...
	public static enum Options {
		...
		/* ------- kone-client mods ------- */ 
		KEY_STROKES_MOD("options.keyStrokesMod", false, true), FULLBRIGHT("options.fullBright", false, true);
