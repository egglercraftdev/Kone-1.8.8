...
public class MainClass {
	...
	public static void showCrashScreen(String t) {
		if(!isCrashed) {
			...
			img.setAttribute("style", "z-index:999;position:absolute;top:10px;left:calc(50% - 155px); width:310px;");
			img.setAttribute("src", "./koneClientHd.png");
			div.setAttribute("style", "z-index:999;position:absolute;top:135px;left:10%;right:10%;bottom:50px;background-color:white;border:1px solid #cccccc;overflow-x:hidden;overflow-y:scroll;overflow-wrap:break-word;white-space:pre-wrap;font: 14px monospace;padding:10px;");
			el.appendChild(img);
			el.appendChild(div);
	...
	public static void showIncompatibleScreen(String t) {
		if(!isCrashed) {
			...
			img.setAttribute("style", "z-index:999;position:absolute;top:10px;left:calc(50% - 155px); width:310px;");
			img.setAttribute("src", "./koneClientHd.png");
			div.setAttribute("style", "z-index:999;position:absolute;top:135px;left:10%;right:10%;bottom:50px;background-color:white;border:1px solid #cccccc;overflow-x:hidden;overflow-y:scroll;font:18px sans-serif;padding:40px;");
			el.appendChild(img);
			el.appendChild(div);
